...
mkdir ~/frappe-bench/sites/f-dog.test

cp -r "${GITHUB_WORKSPACE}/.github/helper/site_config_mariadb.json" ~/frappe-bench/sites/f-dog.test/site_config.json
...
bench --site f-dog.test reinstall --yes
bench --site f-dog.test install-app frappe_dynamic_og
